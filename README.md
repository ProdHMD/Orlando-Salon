# Orlando Salon
Website for https://orlando1salon.com built under the Bedrock 1.24.5 and Sage 10.8.2.
...
3. Direct your terminal path to web/app/themes/orlandosalon and run the following:
  1. `yarn`
  2. `yarn build`
